  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "8px", flexWrap: "wrap", marginTop: "8px" }}>
      ...
      <button type="button" onClick={() => save(date || null)} disabled={busy}
        style={{ padding: "5px 11px", borderRadius: "7px", border: "1px solid rgba(0,211,149,0.35)", background: "rgba(0,211,149,0.12)", color: "var(--green)", fontSize: "11.5px", fontWeight: 600, cursor: busy ? "default" : "pointer", fontFamily: "var(--font-body)", opacity: busy ? 0.6 : 1 }}>
        {busy ? "…" : "Apply"}
      </button>
      {startDate && (
