...
- New buy candidates: apply the marginal dollar question — each new name must beat the risk/reward of adding to an existing high-conviction holding OR represent a clearly superior opportunity. In constructive or mixed macro environments, there should almost always be 1-3 names worth expressing. Do not default to holding all cash; identify where the best marginal dollar is deployed.
