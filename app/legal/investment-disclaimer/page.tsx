  ...
  return (
    <article>
      <div style={{ marginBottom: "32px" }}>
        ...
        <h1 style={{ fontFamily: "var(--font-display)", fontSize: "28px", fontWeight: 700, color: "var(--text-primary)", letterSpacing: "-0.5px", marginBottom: "8px" }}>Investment Disclaimer</h1>
