    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .hero-h .accent{display:inline-block;padding-bottom:8px;margin-bottom:-4px;background:linear-gradient(135deg,#93c5fd 0%,#a78bfa 60%,#7c3aed 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
