...
import ElderCareClient from "./elder-care-client";
...
export default async function ElderCarePage() {
  ...
  const { data: portfolios } = await supabase.from("portfolios").select("id, name, cash_balance, account_type").eq("user_id", user.id);
