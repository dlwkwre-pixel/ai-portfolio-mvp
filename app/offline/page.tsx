...
export default function OfflinePage() {
  return (
    <main style={{
      ...
      <div style={{ width: "56px", height: "56px", background: "var(--brand-gradient)", borderRadius: "14px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "24px" }}>
      ...
      <button
        ...
        style={{ padding: "12px 24px", background: "var(--brand-gradient)", border: "none", borderRadius: "10px", color: "#fff", fontSize: "14px", fontWeight: 600, cursor: "pointer" }}
      >
        Try again
      </button>
    </main>
