...
// Self-hosted display font. next/font ships a metric-matched fallback so headings
// don't reflow (and look "wide") while the webfont loads — kills the login-title
// FOUT that shifted width across devices. Exposed via the --font-display token.
const syne = Syne({
  variable: "--font-syne",
  subsets: ["latin"],
  weight: ["700", "800"],
