          ...
          <div className="bt-page-content" style={{ flex: 1, overflowY: "auto", padding: "24px" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: "40px", maxWidth: "640px" }}>
              ...
              <div style={{ borderTop: "1px solid var(--border-subtle)", paddingTop: "24px", paddingBottom: "16px", display: "flex", flexDirection: "column", gap: "6px" }}>
                ...
                {isAdmin && (
                  <Link href="/admin/compliance" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 12px", borderRadius: "8px", background: "rgba(14,165,160,0.06)", border: "1px solid rgba(14,165,160,0.15)", textDecoration: "none", color: "#3fc9c3", fontSize: "13px", fontWeight: 500, marginTop: "4px", transition: "all 0.15s" }}>
